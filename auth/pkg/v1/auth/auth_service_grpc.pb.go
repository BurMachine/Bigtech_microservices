...
const (
	AuthService_Register_FullMethodName = "/github.com.BurMachine.Bigtech_microservices.auth.AuthService/Register"
	AuthService_Login_FullMethodName    = "/github.com.BurMachine.Bigtech_microservices.auth.AuthService/Login"
	AuthService_Refresh_FullMethodName  = "/github.com.BurMachine.Bigtech_microservices.auth.AuthService/Refresh"
	AuthService_Logout_FullMethodName   = "/github.com.BurMachine.Bigtech_microservices.auth.AuthService/Logout"
	AuthService_JWKS_FullMethodName     = "/github.com.BurMachine.Bigtech_microservices.auth.AuthService/JWKS"
)
...
type AuthServiceClient interface {
	...
	JWKS(ctx context.Context, in *GetJWKSRequest, opts ...grpc.CallOption) (*GetJWKSResponse, error)
}
...
func (c *authServiceClient) JWKS(ctx context.Context, in *GetJWKSRequest, opts ...grpc.CallOption) (*GetJWKSResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	JWKS(context.Context, *GetJWKSRequest) (*GetJWKSResponse, error)
...
func (UnimplementedAuthServiceServer) JWKS(context.Context, *GetJWKSRequest) (*GetJWKSResponse, error) {
...
func _AuthService_JWKS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).JWKS(ctx, req.(*GetJWKSRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.BurMachine.Bigtech_microservices.auth.AuthService",
	...
	Metadata: "v1/auth/auth_service.proto",
}
